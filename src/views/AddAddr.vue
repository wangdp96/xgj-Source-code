...
export default {
  ...
  methods:{
    ...
    saveAddr(){
      ...
      var data = this.qs.stringify({"receiver":this.receiver,"cellphone":this.cellphone,"province":this.province,"city":this.city,"county":this.county,"address":this.fullAddress,"is_default":is_default,"tag":this.tag,"user_id":this.uid});
      ...
      this.axios.post('/addAddr',data).then(res=>{
        this.$toast({
